...
CREATE TABLE `grupos_tecnicos` (
  ...
  PRIMARY KEY (`idGupo`,`idTecnico`),
  KEY `tecnico_idx` (`idTecnico`),
  CONSTRAINT `grupo_tecnico` FOREIGN KEY (`idGupo`) REFERENCES `grupos` (`idGrupos`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tecnico_grupo` FOREIGN KEY (`idTecnico`) REFERENCES `tecnicos` (`idTecnicos`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `grupos_tecnicos` VALUES (1,1,'2023-04-24'),(1,2,'2023-04-24');
...
-- Dump completed on 2023-04-30 12:42:40
